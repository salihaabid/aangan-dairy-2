...
//   return (
//     <div className='flex flex-col md:flex-row items-center justify-between gap-4 p-4 rounded-2xl mt-10 ml-17 '>
...
//                 <button
//                   onClick={handleReset}
//                   className='text-[#3d081b] text-lg underline'
//                 >
//                   Reset
//                 </button>
//               </div>
  ...
  return (
    <>
      ...
      <div className='md:hidden flex justify-between items-center p-4'>
        <button
          className='flex items-center gap-2 text-[#4b5943]/90 font-semibold'
      ...
      {mobileOpen && (
        <div className='fixed inset-0 bg-black bg-opacity-40 z-50 flex'>
          <div className='bg-[#fef7e5] w-3/4 h-full p-6 shadow-2xl rounded-r-2xl flex flex-col'>
            ...
            <div className='mt-auto flex justify-between'>
              ...
              <button
                className='px-5 py-2 rounded-lg bg-[#2a4125] text-white'
                onClick={handleApply}
              >
                Apply
              </button>
